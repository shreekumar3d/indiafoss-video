...
# full audios as the the second video is short (last one only) - so match
# will be close to end
#ffmpeg -i ytlive.mp4 -vn -acodec pcm_s16le -y cut-ytlive-2.wav
#ffmpeg -i procam-2.mp4 -to 10:00 -vn -acodec pcm_s16le -y cut-procam-2.wav
