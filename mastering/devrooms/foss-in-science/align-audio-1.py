...
# 20 minute audios as the livestream has long "starting soon" section
#ffmpeg -i ytlive.mp4 -to 20:00 -vn -acodec pcm_s16le -y cut-ytlive-1.wav
#ffmpeg -i procam-1.mp4 -to 20:00 -vn -acodec pcm_s16le -y cut-procam-1.wav

# Now, align them
results = ad.align_files("cut-procam-1.wav", "cut-ytlive-1.wav", recognizer = correlation_rec)
pprint(results)
