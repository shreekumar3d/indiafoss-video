...
#
#ffmpeg -i localrec-2.mkv -to 05:00 -vn -acodec pcm_s16le cut-localrec-2.wav
#ffmpeg -i procam-2.mp4 -to 05:00 -vn -acodec pcm_s16le cut-procam-2.wav

# Now, align them
results = ad.align_files("cut-procam-2.wav", "cut-localrec-2.wav", recognizer = correlation_rec)
pprint(results)
